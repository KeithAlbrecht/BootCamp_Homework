...
1. Create a new directory for this project called `D3-challenge`. **Do create a new repository for this homework**.
...
* Note: You'll need to use `python -m http.server` to run the visualization. This will host the page at `localhost:8000` in your web browser. `0.0.0.0:8000` may not work on your computer so remember that it is `localhost:8000`.
